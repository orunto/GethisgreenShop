window.onload=function (){
    ...
    // var vid = document.getElementById("order");
    // console.log(vid)
    ...
    function drop () {
        ...
        nextbar.style.boxShadow = "none";
        dropdown.style.boxShadow = "0px 5px 30px rgba(0, 0, 0, 0.25)";
    ...
    function pullup () {
        ...
        nextbar.style.boxShadow = "0px 5px 30px rgba(0, 0, 0, 0.25)";
    ...
    var blueink = document.getElementById('blueink');
    var blackink = document.getElementById('blackink');
    ...
    function thick2 () {
        ...
        quantitynum = sele.options[sele.selectedIndex].value;
    }
    ...
    sel.addEventListener('change', () => {
        quantitynum = sel.options[sel.selectedIndex].value;
    })
    ...
    blackcolor.addEventListener('click', blackcolorid)
    bluecolor.addEventListener('click', bluecolorid)
    greencolor.addEventListener('click', greencolorid)
    redcolor.addEventListener('click', redcolorid)

    blackink.addEventListener('click', blackinkid)
    blueink.addEventListener('click', blueinkid)
    greenink.addEventListener('click', greeninkid)
    redink.addEventListener('click', redinkid)

    function blackcolorid() {
        idnum = 1;
    }
    function bluecolorid() {
        idnum = 2;
    }
    function greencolorid() {
        idnum = 3;
    }
    function redcolorid() {
        idnum = 4;
    ...
    fetch("/create-checkout-session", {
        ...
        body: JSON.stringify({
        items: [
            { id: idnum, quantity: quantitynum },
            { id: leatherbox, quantity: quantitynum },
        ],
        }),
    })
        .then(res => {
